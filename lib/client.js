...
function IpPoolCard(props) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			...
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutlineRegular, { className: ip_pool_module_css_default.chevron + (open ? ` ${ip_pool_module_css_default.chevronOpen}` : "") })]
...
function ipPoolScope(form) {
	...
	return {
		getSnapshot: () => {
			...
			return {
				...snapshot,
				value: snapshot.value?.ipPool,
				base: section(snapshot.base),
				user: section(snapshot.user)
			};
		},
		subscribe,
